...
export default function StartShipment({ startModal, setStartModal, startShipment }) {
  ...
  return startModal ? (
    ...
    <div className='flex items-center min-h-screen px-4 py-8'>
      <div style={{ maxWidth: '400px' }} className='relative w-full p-4 mx-auto bg-white rounded-md shadow-lg'>
        ...
        <div className='max-w-sm mx-auto py-3 space-y-3 text-center'>
          ...
          <form onSubmit={(e) => e.preventDefault()}>
            ...
            <div className='relative mt-3'>
              <input type="text" placeholder="Id" className='w-full pl-5 pr-3 py-2 text-gray-500 bg-transparent outline-none border focus:border-indigo-600 shadow-sm rounded-lg'
                onChange={(e) => setGetProduct({
                  ...getProduct,
